...
import { HeartPulse, Plus, Clock, Edit2, Trash2, X, Sparkles } from "lucide-react";
import { useAppStore } from "@/stores/app-store";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import AICardioPlannerView from "@/components/ai-cardio-planner-view";
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="tracker" className="space-y-6">
        <TabsList className="bg-[#161b22] border border-white/[0.06] p-1 rounded-xl">
          <TabsTrigger value="tracker" className="text-xs rounded-lg data-[state=active]:bg-teal-500 data-[state=active]:text-slate-900 data-[state=active]:font-semibold">Cardio Tracker</TabsTrigger>
